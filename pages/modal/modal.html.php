    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <img src="../../Assets/Imgs/logo3.png" alt="logo" width="200px">
            ...
            <div class="modal-body">
                <form class="container card p-3" method="POST" action="./Script/03-login.php">
                    <div class="form-group mb-3 text-center">
                        ...
                        <input type="email" class="form-control input-text email" placeholder="E-mail" name="email">
                    </div>

                    <div class="form-group mb-3 text-center">
                        <label for="senha">Senha</label>
                        <input type="password" class="form-control input-text senha" placeholder="Senha" name="senha">
                    </div>
...
<div class="modal fade" tabindex="-1" role="dialog" id="modalSingUp">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <img src="../../Assets/Imgs/logo2.png" alt="logo" width="200px">
                <button type="button" class="modal-close-cadastro" data-dismiss="modal" aria-label="Fechar">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form class="container card p-3" method="POST" action="./Script/02-insert.php">
                    <div class="form-group mb-3 text-center">
                        ...
                        <input type="text" class="form-control input-text nomecompleto" placeholder="Seu Nome Completo"
                            name="nomeCompleto">
                    </div>

                    <div class="form-group mb-3 text-center">
                        <label for="cpf">CPF</label>
                        <input type="text" maxlength="11" class="form-control input-text cpf" placeholder="CPF"
                            name="cpf">
                    </div>
...
<div class="modal fade" tabindex="-1" role="dialog" id="modalFaleConosco">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <img src="../../Assets/Imgs/logo2.png" alt="logo" width="250px">
                <button type="button" class="modal-close-cadastro" data-dismiss="modal" aria-label="Fechar">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form class="container card p-3">
                    ...
                    <div class="form-group mb-3 text-center">
                        <label for="email">E-mail</label>
                        <input type="email" class="form-control input-text email" placeholder="E-mail">
                    </div>
